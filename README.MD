...
* **`com.example.a2a.server`:** The server-side implementation.
* **`com.example.a2a.client`:** The client-side implementation.

### Server (`com.example.a2a.server`)
